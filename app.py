...
def precipitation():
    ...
    for each_row in results:
        ...
        dt_dict["precipitation"] = each_row.prcp
        precp_date_tobs.append(dt_dict)

    return jsonify(precp_date_tobs)
...
def last_year():
    ...
    station_hno = query_station_list[0][0]
    print(station_hno)
...
def start_only(start):
    ...
    if valid_entry:
    	...
    	result_printout =( ['Entered Start Date: ' + start,
    						'The lowest temp: '  + str(tmin),
    						'The average temp: ' + str(tavg),
    						'The highest temp: ' + str(tmax)])
